...
public class Main {
    public static void main(String[] args) {
        ...
        var aocDay = new AOCDay18();

        var data = aocDay.part1(aocInput.readInputFile("day-18-example.txt"));
        System.out.println("Part 1 (example):\t%d".formatted(data));

        data = aocDay.part1(aocInput.readInputFile("day-18-input.txt"));
        System.out.println("Part 1 (input):\t\t%d".formatted(data));

        data = aocDay.part2(aocInput.readInputFile("day-18-example.txt"));
        System.out.println("Part 2 (example):\t%d".formatted(data));

        data = aocDay.part2(aocInput.readInputFile("day-18-input.txt"));
